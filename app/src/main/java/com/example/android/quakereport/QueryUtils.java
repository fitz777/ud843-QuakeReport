...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return a {@link List<Earthquake>} object to represent a list of earthquake.
     */
    ...
    private static List<Earthquake> extractFeaturesFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                double magnitude = p.getDouble("mag");
                String location = p.getString("place");
                long timeInMilliseconds = p.getLong("time");
